...
namespace Rubberduck.CodeAnalysis.Inspections.Concrete
{
    ...
    internal sealed class ParameterCanBeByValInspection : DeclarationInspectionBase
    {
        ...
        {
            return string.Format(InspectionResults.ResourceManager.GetString(nameof(ParameterCanBeByValInspection), CultureInfo.CurrentUICulture), declaration.IdentifierName);
        }
    }
}
