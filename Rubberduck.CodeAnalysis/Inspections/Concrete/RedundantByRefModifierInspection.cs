...
namespace Rubberduck.CodeAnalysis.Inspections.Concrete
{
    ...
    internal sealed class RedundantByRefModifierInspection : DeclarationInspectionBase
    {
        ...
        {
            return string.Format(InspectionResults.ResourceManager.GetString("RedundantByRefModifierInspection", CultureInfo.CurrentUICulture), declaration.IdentifierName);
        }
    }
}
