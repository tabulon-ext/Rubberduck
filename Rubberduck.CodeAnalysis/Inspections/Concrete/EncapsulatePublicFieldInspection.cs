...
namespace Rubberduck.CodeAnalysis.Inspections.Concrete
{
    ...
    internal sealed class EncapsulatePublicFieldInspection : DeclarationInspectionBase
    {
        ...
        {
            return string.Format(InspectionResults.ResourceManager.GetString("EncapsulatePublicFieldInspection", CultureInfo.CurrentUICulture), declaration.IdentifierName);
        }
    }
}
